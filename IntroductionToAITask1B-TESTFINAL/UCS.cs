...
namespace IntroToAIAssignment1
{
    internal class UCS
    {
        ...
        public async Task<List<(List<string> Path, int Cost)>>UniformCostSearch(Nodes startNode, Nodes goalNode, Action<int, int, string, int, bool, List<string>> uiCallback, int delay, bool StopAtFirstGoal = false)
        {
