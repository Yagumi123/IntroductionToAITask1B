...
namespace IntroToAIAssignment1
{
    internal class DFS
    {
        ...
        //dfs search 
        public async Task<List<(List<string> Path, int Cost)>> DepthFirstSearch(Nodes startNode, Nodes goalNode, Action<int, int, string, int, bool, List<string>> uiCallback, int delay, bool StopAtFirstGoal = false)
        {
            ...
            // uses a stack for LIFO data structure allowing for the DFS search to function 
